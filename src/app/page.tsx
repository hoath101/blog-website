  ...
  return (
    <main className=''>
      ...
      <code className='absolute text-cyan-200 w-[600px] ml-10 mt-4 pr-4'>
        ...
        Whether you’re here to learn something new, get inspired, or simply enjoy a good read, we’ve got you covered.
        Here, you’ll find a range of topics from lifestyle and wellness to tech and travel, all crafted with your
